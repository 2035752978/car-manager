            ...
            <div v-show="show">
                <div class="top">
                    <el-breadcrumb separator="/">
                        <el-breadcrumb-item> 访客预约管理</el-breadcrumb-item>
                        <el-breadcrumb-item>
                            <a href="/booking" style="font-weight: 400">预约列表</a></el-breadcrumb-item>
                        <el-breadcrumb-item>
                            <a href="javascript:" style="color: #409eff">预约添加</a>
                        </el-breadcrumb-item>
                    </el-breadcrumb>
                </div>
...
<script>
import { addBooking } from '../../../request/api'
export default {
    data() {
        return {
            list: { plateNumber: "", realName: "", phone: "", idCardNo: "", remark: "" },
            show: false,
            value: '',
            value1: ''
        };
