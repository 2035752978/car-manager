            ...
            <div v-show="show">
                <div class="top">
                    <el-breadcrumb separator="/">
                        ...
                        <el-breadcrumb-item>
                            <a href="javascript:" style="color: #409eff">用户添加</a>
                        </el-breadcrumb-item>
                    </el-breadcrumb>
                </div>
                ...
                <div class="list">
                    <div class="l_title"><b>*</b>用户账号</div>
                    <el-input placeholder="请输入内容" clearable v-model="list.username">
                    </el-input>
                </div>
                <div class="list">
                    <div class="l_title"><b>*</b>密码</div>
                    <el-input placeholder="请输入内容" clearable type="password" v-model="list.password">
                    </el-input>
                </div>
                <div class="list">
...
<script>
import { getRole, getDept, getPost, addUser } from '@/request/api';

export default {
    data() {
        return {
            list: { realName: "", username: "", password: "", phone: "", roleId: "3", sex: "", email: "", avatar: "", remark: "" },
            show: false,
            fileList: [],
            roleList: [],
            deptList: [],
