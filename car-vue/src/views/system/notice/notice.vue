            ...
            <div>
                <div class="top">
                    <el-breadcrumb separator="/">
                        ...
                        <el-breadcrumb-item>
                            <a href="" style="color: #409eff">公告列表</a></el-breadcrumb-item>
                    </el-breadcrumb>
                </div>
                <div class="search">
                    <el-form class="demo-form-inline" size="small">
                        <el-form-item label="公告标题" id="zi" style="width: 250px">
                ...
                <el-row style="height: 86px; padding: 0">
                    <div class="btn" @click="add()" style="width: 150px">
                        <el-button type="primary" icon="el-icon-plus">新增公告</el-button>
                    </div>
                </el-row>
                <el-table :data="list.slice((page - 1) * pnum, page * pnum)" tooltip-effect="dark" style="width: 100%"
                    height="600" border :row-style="{ height: '80px' }">
                    <el-table-column type="selection" width="68" align="center"></el-table-column>
                    <el-table-column prop="noticeId" label="公告ID" width="auto" align="center"></el-table-column>
                    <el-table-column prop="noticeTitle" label="公告标题" width="auto" align="center">
                    </el-table-column>
                  <el-table-column prop="createTime" label="创建时间" show-overflow-tooltip align="center"></el-table-column>
                    <el-table-column label="公告状态" width="auto" align="center">
...
<script>
import { getNotice, delNotice } from '../../../request/api'
export default {
    data() {
        return {
            list: [],
    ...
    methods: {
        ...
        edit(a) {
            localStorage.setItem("setNoticeData", JSON.stringify(a))
            this.$router.push("/notice_edit");
        },
        del(k, v) {
